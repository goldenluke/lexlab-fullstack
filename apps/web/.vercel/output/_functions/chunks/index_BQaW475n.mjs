...
function LexPress({ project }) {
  ...
  if (!mounted) return null;
  if (!project) return /* @__PURE__ */ jsx("div", { className: "p-20 text-center opacity-30 font-black uppercase tracking-[0.4em] italic", children: "Selecione uma matéria aprovada para publicação" });
  return /* @__PURE__ */ jsxs("div", { className: "p-8 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-1000 pb-24", children: [
    /* @__PURE__ */ jsxs("header", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic", children: [
          "Lex",
          /* @__PURE__ */ jsx("span", { className: "text-indigo-600", children: "Press" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]", children: "Editoração e Diário Oficial" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsx("button", { className: "p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 hover:text-indigo-600 transition-all shadow-sm", children: /* @__PURE__ */ jsx(Download, { size: 20 }) }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isPublishing ? "Gerando Rastro..." : isPublished ? "Publicado no DOE" : "Publicar Agora"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-50 shadow-2xl rounded-[1rem] p-16 border-t-[12px] border-indigo-600 min-h-[1000px] relative overflow-hidden text-slate-900 font-serif", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 p-8 opacity-10", children: /* @__PURE__ */ jsx(QrCode, { size: 120 }) }),
      /* @__PURE__ */ jsxs("div", { className: "text-center border-b-2 border-slate-200 pb-10 mb-10 space-y-2", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold uppercase tracking-widest", children: "Estado do Tocantins" }),
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black uppercase tracking-tighter", children: "Diário Oficial Legislativo" }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-10 text-[9px] font-bold uppercase py-2", children: [
          /* @__PURE__ */ jsx("span", { children: "ANO XXXVIII - Nº 6.542" }),
          /* @__PURE__ */ jsxs("span", { children: [
            "PALMAS, ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-8 max-w-2xl mx-auto leading-relaxed text-justify", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-right italic font-bold text-sm mb-12", children: [
          '"Dispõe sobre ',
          project.title.toLowerCase(),
          ' e dá outras providências no rastro da gestão de saúde pública."'
        ] }),
        /* @__PURE__ */ jsxs("h3", { className: "font-bold text-center uppercase tracking-widest mb-6 underline", children: [
          "LEI Nº ",
          project.id.replace("LX-", "9.")
        ] }),
        /* @__PURE__ */ jsx("p", { className: "font-bold", children: "O GOVERNADOR DO ESTADO DO TOCANTINS:" }),
        /* @__PURE__ */ jsx("p", { children: "Faço saber que a Assembleia Legislativa decreta e eu sanciono a seguinte Lei:" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "font-bold italic", children: "Art. 1º" }),
            " ",
            project.content || "Fica instituído o rastro normativo conforme diretrizes do LabSUS."
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "font-bold italic", children: "Art. 2º" }),
            " Esta Lei entra em vigor na data de sua publicação."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "pt-20 text-center space-y-1", children: [
          /* @__PURE__ */ jsx("div", { className: "w-48 h-px bg-slate-300 mx-auto mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "font-black uppercase tracking-tighter", children: "Governador do Estado" }),
          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-400", children: "Assinado Digitalmente via LexLab Rastro-ID" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "absolute bottom-10 left-10 flex items-center gap-2 opacity-30", children: [
        /* @__PURE__ */ jsx(ShieldCheck, { size: 16 }),
        /* @__PURE__ */ jsxs("span", { className: "text-[8px] font-black uppercase tracking-widest", children: [
          "Validação Hash: ",
